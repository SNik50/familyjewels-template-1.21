package net.nik.familyjewels.item.custom;
...
public class ChainsawItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        if(!Screen.hasShiftDown()){
            tooltip.add(Text.translatable("tooltip.familyjewels.chainsaw.tooltip.shift"));
        } else {
            tooltip.add(Text.translatable("tooltip.familyjewels.chainsaw.tooltip.1"));
            tooltip.add(Text.translatable("tooltip.familyjewels.chainsaw.tooltip.2"));
        }
